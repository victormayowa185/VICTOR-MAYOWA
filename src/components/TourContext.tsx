  ...
  // Fetch posts that have the "Tour" category, ordered by published date ascending
  const TOUR_QUERY = `*[_type == "post" && "TOUR" in categories[]->title] | order(publishedAt asc){
    _id,
    title,
    excerpt,
    slug,
  ...
  export const TourProvider: React.FC<TourProviderProps> = ({ children }) => {
    ...
    const endTour = () => {
      ...
      clearTourIndex(); // optional – you can keep this or remove it
    };
